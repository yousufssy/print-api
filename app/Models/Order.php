...
class Order extends Model
{
    ...
    /**
     * ✅ علاقة الإيصالات - باستخدام whereColumn للمفتاح المركب
     */
    public function vouchers(): HasMany
    {
        return $this->hasMany(Voucher::class, 'ID', 'ID')
                    ->whereColumn('Voucher.Year', '=', 'MasterW.Year');
    }

    /**
     * ✅ علاقة المشاكل - جدول problems
     */
    public function problems(): HasMany
    {
        return $this->hasMany(Problem::class, 'ID', 'ID')
                    ->whereColumn('problems.Year', '=', 'MasterW.Year');
    }

    /**
     * ✅ علاقة الكرتون/المواد - جدول cartons
     */
    public function cartons(): HasMany
    {
        return $this->hasMany(Carton::class, 'ID', 'ID')
                    ->whereColumn('cartons.year', '=', 'MasterW.Year');
    }

    /**
     * ✅ علاقة العمليات - جدول actions
     * ⚠️ ملاحظة: actions تستخدم order_id كمفتاح أجنبي
     */
